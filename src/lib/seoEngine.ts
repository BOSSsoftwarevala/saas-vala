...
export function generateHomepageSeo(productCount: number = 2000): MetaData {
  const title = 'SaaS Vala - 2000+ Software Products at $5 | Enterprise Solutions';
  const description = `Discover ${productCount}+ software products starting at just $5. Enterprise-grade solutions for healthcare, finance, education, logistics, and more. Trusted by businesses in India and Africa.`;
  ...
  const schema = {
    ...
    '@type': 'Organization',
    name: 'SaaS Vala',
    url: 'https://www.saasvala.com',
    logo: 'https://www.saasvala.com/logo.png',
    description: 'Premium software marketplace offering 2000+ products at affordable prices',
    sameAs: [
      'https://twitter.com/saasvala',
      'https://linkedin.com/company/saasvala',
    ...
    offers: {
      ...
      description: 'Software products starting at $5',
    },
  };
  ...
  return {
    ...
    ogImage: 'https://www.saasvala.com/og-image.jpg',
    schema,
    canonical: 'https://www.saasvala.com',
  };
}
  ...
  const itemList = products.map((product, index) => ({
    ...
    item: {
      ...
      offers: {
        ...
        priceCurrency: 'USD',
        availability: 'https://schema.org/InStock',
        url: `https://www.saasvala.com/product/${product.slug}`,
      },
...
export function generateWebSiteSchema(): object {
  return {
    ...
    name: 'SaaS Vala',
    url: 'https://www.saasvala.com',
    description: 'Premium software marketplace with 2000+ products',
    potentialAction: {
      '@type': 'SearchAction',
      target: 'https://www.saasvala.com/search?q={search_term_string}',
