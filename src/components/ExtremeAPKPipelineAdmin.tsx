...
import {
  ...
  Code, TestTube, Beaker, Bug, Hammer, Wrench,
  Rocket, Rocket as Launch, Globe, Smartphone, Apple, Smartphone as PhoneIcon,
  Fingerprint, ShieldCheck, Lock, Scan, Layers,
  ...
  KeyRound, Crown, Zap as ZapIcon, Target, Target,
  ...
  FileCheck, FileX, FileLock, FileLock as FileUnlock,
  Lock, Key, Lock,
  Key as Keyhole, KeyRound as KeyIcon,
  ...
  Wifi as WifiIcon,
  Wifi as SignalIcon,
  Wifi as SignalHighIcon,
  Wifi as SignalLowIcon,
  Wifi as SignalMediumIcon,
  Wifi as SignalZeroIcon,
  ...
  Heart, Heart as Heartbeat, Heart as HeartPulse,
