...
const navItems: NavItem[] = [
  ...
  { title: 'Products', icon: Package, href: '/products', activePaths: ['/products', '/products/add'] },
  { title: 'Reseller Manager', icon: Users, href: '/reseller-manager', activePaths: ['/reseller-manager', '/resellers'], adminOnly: true },
  { title: 'Marketplace Admin', icon: Store, href: '/marketplace-admin', activePaths: ['/marketplace-admin', '/admin/marketplace'], adminOnly: true },
  { title: 'Keys', icon: Key, href: '/keys' },
  { title: 'Servers', icon: Server, href: '/servers' },
  { title: 'SaaS AI', icon: Cpu, href: '/saas-ai', activePaths: ['/saas-ai', '/saas-ai-dashboard'] },
  ...
  { title: 'Auto-Pilot', icon: Bot, href: '/auto-pilot', activePaths: ['/auto-pilot', '/automation'], adminOnly: true },
